...
/* ---------------- Show star ratings ----------------
   tv_show_rate, the only genuine numeric rating (1–5 scale). */
/* ---------------- Ratings ----------------
   The 5-level star rating (Bad/Meh/Okay/Good/Wow) the user gave, the SAME scale for
   shows, movies and episodes. Show-level from tv_show_rate; episode/movie from the
...
// episode_emotion is TV Time's OLD combined table, it stores the rating in the
